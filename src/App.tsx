...
const copy = {
  ...
  en: {
    ...
    home: {
      ...
      figurePrompt: "Research relation / sketch / figure calibration",
    ...
    <main className="home-page page-enter">
      <section className="editorial-hero shell">
        ...
        <figure className="hero-art">
          <div className="hero-sheet-stack">
            <div className="hero-under-sheet" aria-hidden="true">
              <span>RESEARCH NOTES / 03</span>
              <i />
              <i />
              <i />
            </div>
            <div className="hero-main-sheet">
              <span className="hero-sheet-prompt">{ui.home.figurePrompt}</span>
              <HeroDraftingIllustration label={ui.home.figureAlt} />
              <span className="hero-sheet-version">
                FIGURE 01 / VERSION 03 / 16:9
              </span>
            </div>
          </div>
          <figcaption>
      ...
      <section className="examples-gallery shell" aria-label={ui.nav.examples}>
        {examples.map((example, index) => (
          ...
          >
            ...
            <div
              className="example-case-visual"
              data-figure={`FIGURE / ${String(index + 1).padStart(2, "0")}`}
              data-size={`${example.width} × ${example.height} · ${example.format}`}
            >
              <img
                src={example.src}
                alt={example.alt}
